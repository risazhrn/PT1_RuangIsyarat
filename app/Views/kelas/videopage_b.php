...
<div class="container">
    ...
    <div class="content d-flex">
            ...
            <div class="content-right">
                <iframe width="800" height="450" src="https://www.youtube.com/embed/wC9R0Sw6QaY" title="YouTube video player" title="YouTube video player" frameborder="2" style="border-radius: 15px;" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
</div>
<?= $this->endSection(); ?>